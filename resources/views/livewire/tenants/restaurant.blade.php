    ...
    <form>
        ...
        <div class="w-full flex justify-between gap-2 mb-8">
            ...
            <div class="w-1/2">
                ...
                <input type="text" class="w-full rounded mt-2 @error('restaurant.phone') border-red-700 @enderror" x-mask="(99) 99999-9999" wire:model="restaurant.phone">
           ...
           <div class="w-1/2">
               ...
               <input type="text" class="w-full rounded mt-2 @error('restaurant.whatsapp') border-red-700 @enderror" x-mask="(99) 99999-9999" wire:model="restaurant.whatsapp">
